...
$sections = array();
$totalsec=0;
$sqlsec = "SELECT * from tbl_subjects WHERE SUB_STATUS='ACTIVE' AND SUB_SUMMER ='Yes' GROUP BY SUB_YEAR, SUB_SECTION ORDER BY 'SUB_ID'";
			...
			<div class="container-table">
				<button type="button" class="btn" style="width:150px; margin: auto; margin-top: 30px;" onclick="document.getElementById('id01').style.display='block'">Add Section</button>
                  ...
                  $section = $sections[$i][1];
                    ...
                    <td><a href="#" onclick="showModalSubjects(<?php echo "'".$grade."','".$section."'"?>,'section1')"><i class="fas fa-table" aria-hidden="true"></i>View Subjects</a></td>
                    <td><a href="#" onclick="editSection(<?php echo "'".$grade."','".$section."'"?>,'section1')" style="color:green"><i class="far fa-edit"></i>Edit Section</a></td>
										<td><a onclick="sweetalertdelete('remove-section.php?grade=<?php echo $grade?>&section=<?php echo $section?>&summer=Yes')" href="#" style="color:red;"><i class="fas fa-trash-alt"></i>Remove</a></td>
									</tr>
