...
//get tuition Fees
$sql1 = "SELECT * FROM tbl_tuition WHERE status ='ACTIVE' AND SUMMER = 'Yes' ORDER BY YEARLEVEL,PLAN ASC";
...
if($res1->num_rows>0)
{
    ...
    $listTuition[$totalTuitions][3]=$row1['SUMSTUD'];
    $totalTuitions++;
  }
}
?>
...
<body>
	...
	<section class="section-1">
		<div class="container">
			<h1>Manage Tuition Fees(Summer Class)</h1>
        ...
        <table>
          ...
          for($i=0;$i<$totalTuitions;$i++)
          {
            ...
            <tr>
              ...
              <td><a href="#" style="color:red;" onclick="showDelete('include/funcDelTuition.php?id=<?=$listTuition[$i][0]?>&page=tuition1')"><i class="fas fa-trash-alt"></i>Delete</a></td>
            </tr>
            <?php
          }
          ?>
...
<script>
	...
	xhttp.open("GET", "include/showModalAddTuition.php?page=tuition1", true);
	xhttp.send();
	}
</script>
...
<script>
	...
	xhttp.open("GET", "include/showModalTuition.php?tfid="+tfid+"&page=tuition1", true);
	xhttp.send();
	}
</script>
